...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="jumbotron">
            ...
            <a href="Crud_cadastro.jsp" class="btn btn-primary btn-lg active" role="button" >Cadastramento de Paciente</a>
            <a href="#" class="btn btn-primary btn-lg active" role="button">Buscar por Paciente</a>
            <a href="Crud_Agendamento.jsp" class="btn btn-primary btn-lg active" role="button" >Agendar Exame</a>
