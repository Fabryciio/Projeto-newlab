                            ...
                            <div class="form-group col-lg-3">
                              ...
                              <!--<div
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        <input name="sexo" type="radio" class="custom-control-input" value="1"> 
                                        <label for="sexo" class="custom-control-label">Masculino</label>
                                    </div>
                                    <div class="custom-control custom-checkbox custom-control-inline">
                                        <input name="sexo" type="radio" class="custom-control-input" value="2"> 
                                        <label for="sexo" class="custom-control-label">Ferminino</label>
                                    </div>
                                 </div> -->
                            </div>    
                                <div class="form-group col-lg-4">
                                    <label for="datnascimento">Data de Nascimento:</label> 
                                    <input id="datnascimento" name="datanascimento" type="date" class="form-control " aria-describedby="datnascimentoHelpBlock">
                                </div>
